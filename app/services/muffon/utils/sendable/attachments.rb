      ...
      class Attachments < Muffon::Base
        ...
        def artists_formatted
          artists.map do |raw_artist_data|
            Muffon::Utils::Sendable::Attachments::Artist.call(
              raw_artist_data:
            )
          end
        end
        ...
        def albums_formatted
          albums.map do |raw_album_data|
            Muffon::Utils::Sendable::Attachments::Album.call(
              raw_album_data:
            )
          end
        end
        ...
        def tracks_formatted
          tracks.map do |raw_track_data|
            Muffon::Utils::Sendable::Attachments::Track.call(
              raw_track_data:
            )
          end
        end
        ...
        def videos_formatted
          videos.map do |raw_video_data|
            Muffon::Utils::Sendable::Attachments::Video.call(
              raw_video_data:
            )
          end
        end
        ...
        def video_channels_formatted
          video_channels.map do |raw_video_channel_data|
            Muffon::Utils::Sendable::Attachments::VideoChannel.call(
        ...
        def video_playlists_formatted
          video_playlists.map do |raw_video_playlist_data|
            Muffon::Utils::Sendable::Attachments::VideoPlaylist.call(
        ...
        def playlists_formatted
          playlists.map do |raw_playlist_data|
            Muffon::Utils::Sendable::Attachments::Playlist.call(
              raw_playlist_data:
            )
          end
        end
        ...
        def communities_formatted
          communities.map do |raw_community_data|
            Muffon::Utils::Sendable::Attachments::Community.call(
              raw_community_data:
            )
          end
        end
