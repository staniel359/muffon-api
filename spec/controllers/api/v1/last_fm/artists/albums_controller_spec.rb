...
RSpec.describe API::V1::LastFM::Artists::AlbumsController, type: :controller do
  ...
  let(:wrong_album) do
    { artist: 'Wild Nothing', album: Helpers::Base::RANDOM_STRING }
  end
  let(:wrong_artist) do
    { artist: Helpers::Base::RANDOM_STRING, album: 'Nocturne' }
  end
  ...
  describe 'GET :description' do
    it 'returns 200' do
      VCR.use_cassette 'api/v1/lastfm/artists/albums/desc/success' do
    ...
    it 'returns 404 if wrong album title' do
      VCR.use_cassette 'api/v1/lastfm/artists/albums/desc/wrong_album' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'api/v1/lastfm/artists/albums/desc/wrong_artist' do
