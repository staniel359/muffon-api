...
RSpec.describe API::V1::Deezer::SearchController, type: :controller do
  describe 'GET :artists' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'api/v1/deezer/search/artists/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'api/v1/deezer/search/artists/wrong_query' do
  ...
  describe 'GET :albums' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'api/v1/deezer/search/albums/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'api/v1/deezer/search/albums/wrong_query' do
  ...
  describe 'GET :tracks' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'api/v1/deezer/search/tracks/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'api/v1/deezer/search/tracks/wrong_query' do
