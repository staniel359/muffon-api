RSpec.describe API::V1::Deezer::ArtistsController, type: :controller do
  describe 'GET :albums' do
    it 'returns 200 if artist_id present' do
      VCR.use_cassette 'controllers/api/v1/deezer/artists/albums/success' do
    ...
    it 'returns 400 if no album_type' do
      VCR.use_cassette 'controllers/api/v1/deezer/artists/albums/no_album_type' do
    ...
    it 'returns 404 if wrong artist_id' do
      VCR.use_cassette 'controllers/api/v1/deezer/artists/albums/wrong_id' do
