...
RSpec.describe API::V1::Discogs::GroupsController, type: :controller do
  ...
  describe 'GET :tags' do
    it 'returns 200 if group_id present' do
      VCR.use_cassette 'api/v1/discogs/groups/tags/success' do
    ...
    it 'returns 404 if wrong group_id' do
      VCR.use_cassette 'api/v1/discogs/groups/tags/wrong_id' do
        get :tags, params: { group_id: Helpers::Base::RANDOM_STRING }
        expect(response).to have_http_status(:not_found)
      end
    end
  end
