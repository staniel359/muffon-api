RSpec.describe API::V1::Bandcamp::Artists::TracksController, type: :controller do
  describe 'GET :info' do
    it 'returns 200 if track present' do
      VCR.use_cassette 'controllers/api/v1/bandcamp/artists/tracks/info/success' do
    ...
    it 'returns 404 if wrong track' do
      VCR.use_cassette 'controllers/api/v1/bandcamp/artists/tracks/info/wrong_track' do
  ...
  describe 'GET :description' do
    it 'returns 200 if track present' do
      VCR.use_cassette 'controllers/api/v1/bandcamp/artists/tracks/description/success' do
    ...
    it 'returns 404 if wrong track' do
      VCR.use_cassette 'controllers/api/v1/bandcamp/artists/tracks/description/wrong_track' do
  ...
  describe 'GET :tags' do
    it 'returns 200 if track present' do
      VCR.use_cassette 'controllers/api/v1/bandcamp/artists/tracks/tags/success' do
    ...
    it 'returns 404 if wrong track' do
      VCR.use_cassette 'controllers/api/v1/bandcamp/artists/tracks/tags/wrong_track' do
