...
RSpec.describe API::V1::Genius::SearchController, type: :controller do
  describe 'GET :artists' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'api/v1/genius/search/artists/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'api/v1/genius/search/artists/wrong_query' do
  ...
  describe 'GET :albums' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'api/v1/genius/search/albums/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'api/v1/genius/search/albums/wrong_query' do
