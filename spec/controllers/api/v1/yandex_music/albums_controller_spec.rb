...
RSpec.describe API::V1::YandexMusic::AlbumsController, type: :controller do
  describe 'GET :info' do
    it 'returns 200 if album_id present' do
      VCR.use_cassette 'api/v1/yandexmusic/albums/info/success' do
    ...
    it 'returns 400 if wrong album_id' do
      VCR.use_cassette 'api/v1/yandexmusic/albums/info/wrong_id' do
  ...
  describe 'GET :tags' do
    it 'returns 200 if album_id present' do
      VCR.use_cassette 'api/v1/yandexmusic/albums/tags/success' do
    ...
    it 'returns 400 if wrong album_id' do
      VCR.use_cassette 'api/v1/yandexmusic/albums/tags/wrong_id' do
