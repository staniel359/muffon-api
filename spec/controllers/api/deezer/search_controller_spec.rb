RSpec.describe API::Deezer::SearchController, type: :controller do
  describe 'GET :artists' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/deezer/search/artists/wrong_query' do
  ...
  describe 'GET :albums' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'controllers/api/deezer/search/albums/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/deezer/search/albums/wrong_query' do
  ...
  describe 'GET :tracks' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'controllers/api/deezer/search/tracks/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/deezer/search/tracks/wrong_query' do
