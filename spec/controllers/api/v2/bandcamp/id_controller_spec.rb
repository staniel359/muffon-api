RSpec.describe API::V2::Bandcamp::IdController, type: :controller do
  describe 'GET :artist' do
    it 'returns 200 if artist present' do
      VCR.use_cassette 'controllers/api/v2/bandcamp/id/artist/success' do
    ...
    it 'returns 404 if wrong artist' do
      VCR.use_cassette 'controllers/api/v2/bandcamp/id/artist/wrong_name' do
  ...
  describe 'GET :album' do
    it 'returns 200 if album present' do
      VCR.use_cassette 'controllers/api/v2/bandcamp/id/album/success' do
    ...
    it 'returns 404 if wrong album' do
      VCR.use_cassette 'controllers/api/v2/bandcamp/id/album/wrong_title' do
  ...
  describe 'GET :track' do
    it 'returns 200 if track present' do
      VCR.use_cassette 'controllers/api/v2/bandcamp/id/track/success' do
    ...
    it 'returns 404 if wrong track' do
      VCR.use_cassette 'controllers/api/v2/bandcamp/id/track/wrong_title' do
