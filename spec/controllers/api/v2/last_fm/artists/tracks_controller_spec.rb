RSpec.describe API::V2::LastFM::Artists::TracksController, type: :controller do
  describe 'GET :info' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/info/success' do
    ...
    it 'returns 404 if wrong track title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/info/wrong_track' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/info/wrong_artist' do
  ...
  describe 'GET :description' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/description/success' do
    ...
    it 'returns 404 if wrong track title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/description/wrong_track' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/description/wrong_artist' do
  ...
  describe 'GET :tags' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/tags/success' do
    ...
    it 'returns 404 if wrong track title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/tags/wrong_track' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/tags/wrong_artist' do
  ...
  describe 'GET :similar' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/similar/success' do
    ...
    it 'returns 404 if wrong track title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/similar/wrong_track' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/tracks/similar/wrong_artist' do
