RSpec.describe API::V2::LastFM::Artists::AlbumsController, type: :controller do
  describe 'GET :info' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/info/success' do
    ...
    it 'returns 404 if wrong album title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/info/wrong_album' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/info/wrong_artist' do
  ...
  describe 'GET :description' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/description/success' do
    ...
    it 'returns 404 if wrong album title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/description/wrong_album' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/description/wrong_artist' do
  ...
  describe 'GET :tags' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/tags/success' do
    ...
    it 'returns 404 if wrong album title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/tags/wrong_album' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/tags/wrong_artist' do
  ...
  describe 'GET :listeners_count' do
    it 'returns 200' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/listeners/success' do
    ...
    it 'returns 404 if wrong album title' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/listeners/wrong_album' do
    ...
    it 'returns 404 if wrong artist name' do
      VCR.use_cassette 'controllers/api/v2/lastfm/artists/albums/listeners/wrong_artist' do
