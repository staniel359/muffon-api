RSpec.describe API::V2::Spotify::ArtistsController, type: :controller do
  describe 'GET :albums' do
    it 'returns 200 if artist_id present' do
      VCR.use_cassette 'controllers/api/v2/spotify/artists/albums/success' do
    ...
    it 'returns 400 if no album type' do
      VCR.use_cassette 'controllers/api/v2/spotify/artists/albums/no_type' do
