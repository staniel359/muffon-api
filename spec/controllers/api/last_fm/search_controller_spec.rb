RSpec.describe API::LastFM::SearchController, type: :controller do
  describe 'GET :artists' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/lastfm/search/artists/wrong_query' do
  ...
  describe 'GET :albums' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'controllers/api/lastfm/search/albums/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/lastfm/search/albums/wrong_query' do
  ...
  describe 'GET :tracks' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'controllers/api/lastfm/search/tracks/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/lastfm/search/tracks/wrong_query' do
  ...
  describe 'GET :tags' do
    it 'returns 200 if query present' do
      VCR.use_cassette 'controllers/api/lastfm/search/tags/success' do
    ...
    it 'returns 404 if wrong query' do
      VCR.use_cassette 'controllers/api/lastfm/search/tags/wrong_query' do
