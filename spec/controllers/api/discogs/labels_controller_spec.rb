RSpec.describe API::Discogs::LabelsController do
  describe 'GET :info' do
    ...
    it 'returns 404 if wrong label_id' do
      VCR.use_cassette 'controllers/api/discogs/label/info/wrong_id' do
  ...
  describe 'GET :description' do
    it 'returns 200 if label_id present' do
      VCR.use_cassette 'controllers/api/discogs/label/description/success' do
    ...
    it 'returns 404 if wrong label_id' do
      VCR.use_cassette 'controllers/api/discogs/label/description/wrong_id' do
  ...
  describe 'GET :albums' do
    it 'returns 200 if label_id present' do
      VCR.use_cassette 'controllers/api/discogs/label/albums/success' do
    ...
    it 'returns 404 if wrong label_id' do
      VCR.use_cassette 'controllers/api/discogs/label/albums/wrong_id' do
