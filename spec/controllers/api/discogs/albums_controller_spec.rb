RSpec.describe API::Discogs::AlbumsController do
  describe 'GET :info' do
    ...
    it 'returns 404 if wrong album_id' do
      VCR.use_cassette 'controllers/api/discogs/albums/info/wrong_id' do
  ...
  describe 'GET :description' do
    it 'returns 200 if album_id present' do
      VCR.use_cassette 'controllers/api/discogs/albums/description/success' do
    ...
    it 'returns 404 if wrong album_id' do
      VCR.use_cassette 'controllers/api/discogs/albums/description/wrong_id' do
  ...
  describe 'GET :tags' do
    it 'returns 200 if album_id present' do
      VCR.use_cassette 'controllers/api/discogs/albums/tags/success' do
    ...
    it 'returns 404 if wrong album_id' do
      VCR.use_cassette 'controllers/api/discogs/albums/tags/wrong_id' do
