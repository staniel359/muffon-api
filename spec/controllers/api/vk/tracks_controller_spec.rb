RSpec.describe API::VK::TracksController do
  ...
  describe 'GET :albums' do
    it 'returns 200 if track exists' do
      VCR.use_cassette 'controllers/api/vk/tracks/albums/success' do
        get :albums, params: { track_id: '138779021_456239923' }
      end
    ...
    it 'returns 404 if wrong track_id' do
      VCR.use_cassette 'controllers/api/vk/tracks/albums/wrong_id' do
