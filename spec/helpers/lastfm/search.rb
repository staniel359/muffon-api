  ...
  module LastFM
    module Search
      class << self
        ...
        def tracks_data
          {:search=>{:page=>2, :total_pages=>40, :tracks=>[{:artist=>{:name=>"Wild Nothing"}, :artists=>[{:name=>"Wild Nothing", :source=>{:name=>"lastfm"}}], :player_id=>"1", :source=>{:name=>"lastfm"}, :title=>"Chinatown (Live from Brooklyn Steel)"}, {:artist=>{:name=>"Wild Nothing"}, :artists=>[{:name=>"Wild Nothing", :source=>{:name=>"lastfm"}}], :player_id=>"1", :source=>{:name=>"lastfm"}, :title=>"Gemini - Chinatown"}, {:artist=>{:name=>"Wild_Nothing"}, :artists=>[{:name=>"Wild_Nothing", :source=>{:name=>"lastfm"}}], :player_id=>"1", :source=>{:name=>"lastfm"}, :title=>"Chinatown"}, {:artist=>{:name=>"Wild Nothing"}, :artists=>[{:name=>"Wild Nothing", :source=>{:name=>"lastfm"}}], :player_id=>"1", :source=>{:name=>"lastfm"}, :title=>"10 Chinatown"}, {:artist=>{:name=>"Wild Nothing"}, :artists=>[{:name=>"Wild Nothing", :source=>{:name=>"lastfm"}}], :player_id=>"1", :source=>{:name=>"lastfm"}, :title=>"\"Chinatown\" from the album Gemini (Captured Tracks) - Wild N"}]}}
        end
      end
    end
  end
