    ...
    module SoundCloud
      module Track
        def soundcloud_track_albums_data
          {track: {:albums=>[], :artist=>{:name=>"Wild_Nothing"}, :artists=>[{:name=>"Wild_Nothing", :source=>{:id=>3820545, :name=>"soundcloud"}}], :source=>{:id=>12472418, :links=>{:original=>"https://soundcloud.com/wildnothing/chinatown", :streaming=>"https://song.link/sc/12472418"}, :name=>"soundcloud"}, :title=>"Chinatown"}}
        end

        def soundcloud_track_info_data
          {track: {artist: {name: "Wild_Nothing"}, artists: [{name: "Wild_Nothing", source: {id: 3820545, name: "soundcloud"}}], audio: {link: "https://cf-media.sndcdn.com/aPeRGvbN3lfq.128.mp3?Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiKjovL2NmLW1lZGlhLnNuZGNkbi5jb20vYVBlUkd2Yk4zbGZxLjEyOC5tcDMqIiwiQ29uZGl0aW9uIjp7IkRhdGVMZXNzVGhhbiI6eyJBV1M6RXBvY2hUaW1lIjoxNzczNDgxOTIyfX19XX0_&Signature=f1-CKx~rsyhMy2Ev61vCv6UMW4T-z4gMMGyO7vozltvSgADP~eoedpRg5bKxOYjeqV9yrQs8-emFy5PEUfGD4k7EdThSCFbMJEnq-EXeafbboH0A0neDVkKADpduaLYRlZsPyaTiUta~csJA5i5JvMd2j7g8e2oxI5KeIG8X5T4BKdBRGoiO171exSbnljNHmEh3mgsYbmNLSnaIkbnYZ0VqwJn~pg6Ol-fZSLR~6uDsQV4hQM2sfYamHH2q1F0SmvlLeLNGzcfGchpsOTZfKRtabb3~5mrS4DBsmmZviyZmNNAJ-iHDDGOjb7T-PKfU0-qUF1-HSMwOkBFl3mLN7Q__&Key-Pair-Id=APKAI6TU7MMXM5DG6EPQ", present: true}, duration: 198, image: {extrasmall: "https://i1.sndcdn.com/artworks-000005813687-l755p4-t67x67.jpg", large: "https://i1.sndcdn.com/artworks-000005813687-l755p4-t500x500.jpg", medium: "https://i1.sndcdn.com/artworks-000005813687-l755p4-t300x300.jpg", original: "https://i1.sndcdn.com/artworks-000005813687-l755p4-t500x500.jpg", small: "https://i1.sndcdn.com/artworks-000005813687-l755p4-large.jpg"}, listeners_count: 0, player_id: "1-12472418", profiles_count: 0, source: {id: 12472418, links: {original: "https://soundcloud.com/wildnothing/chinatown", streaming: "https://song.link/sc/12472418"}, name: "soundcloud"}, tags: [{name: "Pop"}], title: "Chinatown", with_more: {tags: false}}}
        end
