RSpec.describe Discogs::Album::Info do
  ...
  describe 'successful processing' do
    context 'when album_id given' do
      ...
      it { expect(output).to match_hash(discogs_album_info_data) }
    end
    ...
    context 'when different artists' do
      ...
      it { expect(output).to match_hash(discogs_album_info_different_artists_data) }
    end
    ...
    context 'when multiple artists' do
      ...
      it { expect(output).to match_hash(discogs_album_info_multiple_artists_data) }
    end
  end
