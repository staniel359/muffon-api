RSpec.describe YouTube::Channel::Description do
  ...
  describe 'successful processing' do
    context 'when channel present' do
      let(:output) do
        VCR.use_cassette(
          'services/youtube/channel/description/success'
        ) do
          subject.call(
      ...
      it { expect(output).to match_hash(youtube_channel_description_data) }
    end
  end
  ...
  describe 'no processing' do
    ...
    context 'when wrong channel_id' do
      let(:output) do
        VCR.use_cassette(
          'services/youtube/channel/description/wrong_id'
        ) do
          subject.call(
