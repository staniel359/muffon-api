RSpec.describe MusicBrainz::Track::Tags do
  ...
  describe 'successful processing' do
    context 'when track_id present' do
      let(:output) do
        VCR.use_cassette 'services/musicbrainz/track/tags/success' do
          subject.call(track_id: '6029d549-5858-4936-9156-b90770d2ae92')
        end
      end

      it { expect(output).to eq(Helpers::MusicBrainz::Track.tags_data) }
    end
  end
  ...
  describe 'no processing' do
    ...
    context 'when wrong track_id' do
      let(:output) do
        VCR.use_cassette 'services/musicbrainz/track/tags/wrong_id' do
